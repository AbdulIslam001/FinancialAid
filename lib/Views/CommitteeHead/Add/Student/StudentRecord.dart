                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) {
                                  return UpdatePassword(id: snapshot.data![index].studentId,aridNo: snapshot.data![index].aridNo, name: snapshot.data![index].name);
                                },));
                              },
                              child: Container(
                                ...
                                child: ListTile(
                                  leading: CircleAvatar(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child:EndPoint.imageUrl+snapshot.data![index].profileImage==
                                          EndPoint.imageUrl+"null"||EndPoint.imageUrl+snapshot.data![index].profileImage==EndPoint.imageUrl?(
                                          snapshot.data![index].gender=='M'?Image.asset("Assets/male.png"):Image.asset("Assets/female.png"))
                                          :Image(
